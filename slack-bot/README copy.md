...
Note: The example .env now defaults to the public FeedbackFlow API base (https://api.feedbackflow.app/api). Provide your API key in `FEEDBACKFLOW_API_KEY`. Never commit real API keys to the repository.
